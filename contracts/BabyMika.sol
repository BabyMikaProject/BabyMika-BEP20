...
contract BabyMika is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyMika";
    string private constant _symbol = "BBMK";
    ...
    uint256 public _treasuryFee = 150;
    uint256 private _prevTreasuryFee = _treasuryFee;

    uint256 public _buyBackFee = 150;
